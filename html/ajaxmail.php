...
$fromEmail = 'hello@getcaila.com'; // Replace with your email address
$toEmail = 'hello@getcaila.com'; // Replace with your email address
$subject = 'Caila Contact Us Mail';
// Changes end here
...
if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    $output['status'] = 'fail';
    $output['message'] = '<div class="alert alert-warning"Hey there! Please provide valid Email.</div>';
